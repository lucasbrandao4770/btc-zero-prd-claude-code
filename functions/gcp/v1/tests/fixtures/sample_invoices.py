...
SAMPLE_IFOOD_INVOICE = {
    ...
    "commission_amount": "1115.55",
    "total_amount": "4346.45",
}
...
SAMPLE_EXTRACTED_INVOICE = ExtractedInvoice(
    ...
    subtotal=Decimal("1435.00"),
    tax_amount=Decimal("0.00"),
    commission_rate=Decimal("0.25"),
    commission_amount=Decimal("358.75"),
    total_amount=Decimal("1076.25"),
)
...
def create_sample_invoice(
    ...
    return ExtractedInvoice(
        ...
        total_amount=total_amount or Decimal("950.00"),
    )
